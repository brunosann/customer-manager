      ...
      <div class="box-filters">
        <label class="label-filter">
          <input type="radio" name="date" id="day" value="day"
            {{ !Request::has('date') || Request::has('date') == 'day' ? 'checked' : '' }}>
          <span>Hoje</span>
        </label>
        <label class="label-filter">
          <input type="radio" name="date" id="week" value="week"
            {{ Request::input('date') == 'week' ? 'checked' : '' }}>
          <span>Essa Semana</span>
        </label>
        <label class="label-filter">
          <input type="radio" name="date" id="month" value="month"
            {{ Request::input('date') == 'month' ? 'checked' : '' }}>
          <span>Mês</span>
        </label>
      </div>
      ...
      @foreach ($clients as $client)
        <li class="list-item">
          ...
          <div class="actions">
            ...
            <button type="button" class="btn-list delete" data-id="{{ $client->id }}">
